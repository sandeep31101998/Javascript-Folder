...
class UI {
  ...
  static validateInputs() {
    ...
    if (!licensePlateRegex.test(licensePlate)) {
      UI.showAlert(
        "Vehicle number must be like KA-00-AA-1234",
        "danger"
      );
      return false;
    }
...
document.querySelector("#entryForm").addEventListener("submit", (e) => {
  ...
  UI.showAlert("Car successfully added to the parking space", "success");
});
//Event Remove
document.querySelector("#tableBody").addEventListener("click", (e) => {
  ...
  UI.showAlert("Car successfully removed from the parking space list", "success");
});
